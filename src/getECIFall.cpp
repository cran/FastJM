...
// [[Rcpp::export]]
Rcpp::List getECIFall_JMH(const Eigen::VectorXd & beta, const Eigen::VectorXd & tau, 
                      const Eigen::VectorXd & gamma1, const Eigen::VectorXd & gamma2, 
                      const Eigen::VectorXd & alpha1, const Eigen::VectorXd & alpha2, 
  ...
  for (db=0;db<point;db++) {
    ...
    Eigen::VectorXd GetCIF1all = GetCIF1CRall_JMH(gamma1,gamma2,alpha1,alpha2,nu1,nu2,X2,H01,H02,s,timecif1,ri,(p1a+1));
    Eigen::VectorXd GetCIF2all = GetCIF2CRall_JMH(gamma1,gamma2,alpha1,alpha2,nu1,nu2,X2,H01,H02,s,timecif2,ri,(p1a+1));
